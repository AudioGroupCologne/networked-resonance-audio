/* based on NAF networked-audio-source.js https://github.com/networked-aframe/networked-aframe/tree/master/src/components */

AFRAME.registerComponent("networked-resonance-audio", {
  schema: {
  ...
  _setupSound(newStream) {
    ...
    el.setAttribute("resonance-audio-src", "src", newStream);
